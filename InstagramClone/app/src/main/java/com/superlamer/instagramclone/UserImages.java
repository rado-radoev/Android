...
public class UserImages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout userPhotosLayout = (LinearLayout) findViewById(R.id.userPhotosLayout);
...
//        LinearLayout userPhotosLayout = (LinearLayout) findViewById(R.id.userPhotosLayout);
//
//        ImageView imageView = new ImageView(getApplicationContext());
//
//        imageView.setLayoutParams(new ViewGroup.LayoutParams(
